...
//            + " FOREIGN KEY (manufacturer_id) REFERENCES manufacturer(id)"
    ...
    private static final String mainProjectquery = " CREATE TABLE mainProject ("
            + " id  INTEGER PRIMARY KEY autoincrement,"
            + " active TEXT  NOT NULL DEFAULT 'Y',"
            + " Project_name TEXT DEFAULT NULL,"
            + " Operator TEXT DEFAULT NULL,"
            + " Comment TEXT DEFAULT NULL,"
            + " GGAString TEXT DEFAULT NULL,"
            + " status TEXT DEFAULT NULL,"
            + " accuracy TEXT DEFAULT NULL,"
            + " remark TEXT DEFAULT NULL,"
            + " revision_no INTEGER DEFAULT NULL,"
    ...
    private static final String crctypequery = " CREATE TABLE crc_type ("
            + " crc_type_id INTEGER  PRIMARY KEY,"
            + " crc_type_name TEXT DEFAULT NULL,"
            + " remark TEXT DEFAULT NULL"
            + ");";
        ...
        try {
            ...
            if (result) {
               ...
               // db.execSQL(manufactrurQuery);
                ...
                db.execSQL(crccommandmappingquery);
                db.execSQL(crctypequery);
                result = true;
            }
        } catch (Exception e) {
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        ...
        db.execSQL("DROP TABLE IF EXISTS mainProject");
        db.execSQL("DROP TABLE IF EXISTS command_crc_mapping");
        db.execSQL("DROP TABLE IF EXISTS crc_type");
